...
class Response {
    ...
    static public function error($code, $msg = '', $data = array()) {
        $returnData = array(
            'code' => $code,
            'msg'  => empty($msg) ? C('API_ERROR_CODE')[$code] : $msg,
            'data' => $data
        );
...
//        header("Access-Control-Allow-Headers: version, access-token, user-token");
...
//        }
     ...
     * @param null $code
     */
    static public function success($data = array(), $code = null) {
