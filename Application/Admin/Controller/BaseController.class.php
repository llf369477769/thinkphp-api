...
class BaseController extends Controller {
    ...
    public function _initialize(){
        ...
        if (!$config_dict) {
            $config_dict = D('ApiConfigDict')->getDictLists();
        ...
        //添加网站设置配置
        D('api_config')->setConfig();

        $huaan_url = C('HUAAN_URL');
        $this->assign('huaan_url',$huaan_url);
                ...
                if (!$check) {
                    ...
                    if (strtolower($this->url) == 'index/index'){ //登录时没有首页的权限直接返回登录页面
                        ...
                        if(IS_AJAX){
                            ...
                            $this->error(L('_VALID_ACCESS_'), U('Login/ruleTip'));
                        }
